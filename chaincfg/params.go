...
var MainNetParams = Params{
	...
	// BIP 173.
	Bech32HRPSegwit: "df", // always bc for main net

	// Address encoding magics
	PubKeyHashAddrID: 0x12,
	ScriptHashAddrID: 0x5a,
	PrivateKeyID:     0x80,

	// Old witness prefixes. Commented, 'cause it's unused
...
var TestNet3Params = Params{
	...
	// Address encoding magics
	PubKeyHashAddrID: 0xf,
	ScriptHashAddrID: 0x80,
